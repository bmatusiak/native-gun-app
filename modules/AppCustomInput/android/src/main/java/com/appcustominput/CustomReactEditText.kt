...
class CustomReactEditText(context: ThemedReactContext) : ReactEditText(context) {
  ...
  init {
    try { this.background = null } catch (e: Exception) {}
  ...
  override fun onCreateInputConnection(outAttrs: EditorInfo): InputConnection? {
    ...
    try { EditorInfoCompat.setContentMimeTypes(outAttrs, arrayOf("image/*", "image/gif", "image/webp")) } catch (e: Exception) {}
    return ic
  }
}
